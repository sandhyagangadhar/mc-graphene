...
def plot_points_with_mid_points(p_sorted_point_array, mid_pt_x_values, mid_pt_y_values,mid_pt_z_values):
    ...
    ax.plot(mid_pt_x_values, mid_pt_y_values, mid_pt_z_values, c='r', marker='o')
...
def plot_dumbbell_list(p_dumbbell_list):
 ...
 #   ax.scatter(c_x_values, c_y_values, c_z_values, c='y')
    ax.plot(u_x_values, u_y_values, u_z_values, c='b')
    ax.plot(d_x_values, d_y_values, d_z_values, c='b')
 #   ax.set_zlim(-1,1)
    plt.show()
...
def connect(pd: Dumbbell, p_dumbbell_array: [], pi: int, pj: int):
    ...
    #    ax.plot([pd.u.x, sourceDumbell.d.x], [pd.u.y, sourceDumbell.d.y], [pd.u.z, pd.u.z], c='b',marker='o')
    #    ax.plot([pd.u.x, sourceDumbell.d.x], [pd.u.y, sourceDumbell.d.y], [pd.u.z, pd.u.z+10], c='b',marker='o')
        ax.plot([pd.u.x, sourceDumbell.d.x], [pd.u.y, sourceDumbell.d.y], [pd.u.z, sourceDumbell.d.z], c='b',marker='o')
     #   ax.plot([pd.u.x, sourceDumbell.d.x], [pd.u.y, sourceDumbell.d.y], [pd.d.z, pd.d.z+10], c='b',marker='o')
  ...
  #  ax.scatter(d_x_values, d_y_values, d_z_values, c='b')
    ...
    for i in range(9):
        for j in range(0, dumbbell_array.shape[1]):
          ...
          #  ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y], [d.u.z, d.u.z], c='b',marker='o')
        #    ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y], [d.u.z, d.u.z+10], c='b',marker='o')
         #   ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y], [d.u.z, d.u.z], c='b',marker='o')
            ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y], [d.u.z, d.d.z], c='b',marker='o')
         #   ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y], [d.d.z, d.d.z+10], c='b',marker='o')
          #  ax.scatter([d.u.x, d.d.x], [d.u.y, d.d.y], [0, d.u.z+6], c='r',marker='o')
          #  ax.scatter([d.u.x, d.d.x], [d.u.y, d.d.y], [0, d.d.z+6], c='r',marker='o')
           # f1.write( '{:f}\t{:f}\t{:f}\n'.format(d.u.x, d.u.y, d.u.z))
            #f1.write( '{:f}\t{:f}\t{:f}\n'.format(d.d.x, d.d.y, d.d.z))
   #         ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y],[0, d.d.z],c='b',marker='o')
   #         ax.plot([d.u.x, d.d.x], [d.u.y,d.d.y], [0, d.d.z], c='y',marker='o')
   #         ax.plot([d.u.x, d.u.z], [d.u.y, d.u.z], [d.u.z, d.u.z], c='r',marker='o')
    #        ax.scatter([d.u.x, d.d.x], [d.u.y, d.d.y], [0, d.u.z+5], c='r', marker='o')
    #        ax.scatter([d.u.x, d.u.z], [d.u.y, d.u.z], c='r', marker='o')
   #         ax.plot([d.u.x, d.d.x], [d.u.y, d.d.y], [d.d.z, d.d.z], c='b',marker='o')

  #          plt.plot(d.u.z,d.u.z+10)
